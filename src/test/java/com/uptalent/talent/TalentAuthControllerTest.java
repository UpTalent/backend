...
public class TalentAuthControllerTest {
    ...
    void loginSuccessfully() throws Exception {
        AuthLogin loginRequest = new AuthLogin(talent.getCredentials().getEmail(), talent.getCredentials().getPassword());
    ...
    void failLoginWithBadCredentials() throws Exception {
        AuthLogin loginRequestWithBadCredentials =
                new AuthLogin(talent.getCredentials().getEmail(), "another_password");
